...
class Workspace:
    def __init__(self, cfg, logging=True):
        ...
        self.encoder_psi = copy.deepcopy(self.model).to(DEFAULT_DEVICE)
    ...
    def train(self):
        ...
        while train_until_step(self.global_step):
            ...
            metrics, st = trainer.update(self.model, self.encoder_psi, (batch_f.cuda(), batch_rewards), self.global_step)
            t2 = time.time()
            ...
            if eval_every_step(self.global_step):
                with torch.no_grad():
                    ...
                    metrics, st = trainer.update(self.model, self.encoder_psi, (batch_f.cuda(), batch_rewards), self.global_step, eval=True)
